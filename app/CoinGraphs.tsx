                ...
                <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={coinData[currentCoinIndex]?.prices.map((priceData: [number, number]) => {
                            ...
                            <YAxis />
                            <Line type="monotone" dataKey="price" stroke={`hsl(${Math.random() * 360}, 100%, 50%)`} strokeWidth={2} dot={false} />
                        </LineChart>
                    </ResponsiveContainer>
                </CardContent>
            </Card>
